...
struct edge_hist_t {
  ...
  int16_t yaw;           // Edge_hist: pan: rotation around the z-axis of the camera  (perpendicular on frame plane) rad]
  int16_t pitch;          // Edge_hist: tilt: rotation around the y-axis of the camera (along image width) [rad]
  int16_t roll;            // Edge_hist: roll: rotation around the x-axis of the camera (along image height) [rad]
};
