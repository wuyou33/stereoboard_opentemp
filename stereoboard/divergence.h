...
void calculate_edge_flow_simple(uint8_t *in, uint32_t *edge_histogram, uint32_t *edge_histogram_prev,
...
int32_t calculate_edge_flow(uint8_t *in, struct displacement_t *displacement, struct edge_flow_t *edge_flow,
                            struct edge_hist_t *edge_hist, uint16_t *height, uint8_t current_frame_nr,
                            int16_t windowsize, int16_t max_distance, int16_t edge_threshold, uint16_t image_width, uint16_t image_height,
                            uint16_t RES);
