...
#define OV7670_ADDR_WRITE      0x42 // or was this a decimal value?
#define OV7670_ADDR_READ       0x43


uint8_t ov7670_WriteReg(uint8_t Addr, uint8_t Data);
uint8_t ov7670_ReadReg(uint8_t Addr, uint8_t *reply);
...
uint8_t ov7670_WriteReg(uint8_t Addr, uint8_t Data)
{
  ...
  I2C_Send7bitAddress(I2C2, OV7670_ADDR_WRITE, I2C_Direction_Transmitter);
...
uint8_t ov7670_ReadReg(uint8_t Addr, uint8_t *reply)
{
  ...
  /* Send DCMI selected device slave Address for write */
  I2C_Send7bitAddress(I2C2, OV7670_ADDR_READ, I2C_Direction_Receiver);
