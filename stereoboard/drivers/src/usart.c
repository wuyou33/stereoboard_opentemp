...
void usart_init(void)
{
  ...
  uart_init_hw(&USART2_Data, USART2_BAUD);
#endif
  ...
  uart_init_hw(&USART3_Data, USART3_BAUD);
#endif
  ...
  uart_init_hw(&USART4_Data, USART4_BAUD);
  ...
  uart_init_hw(&USART5_Data, USART5_BAUD);
#endif
  ...
  uart_init_hw(&USART6_Data, USART6_BAUD);
#endif
}
